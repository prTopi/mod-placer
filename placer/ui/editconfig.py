...
class Ui_EditConfigDialog(object):
    def setupUi(self, EditConfigDialog):
        ...
        self.formLayout = QtWidgets.QFormLayout(EditConfigDialog)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.gameLabel)
        self.gameLineEdit = QtWidgets.QLineEdit(EditConfigDialog)
        self.gameLineEdit.setObjectName("gameLineEdit")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.gameLineEdit)
        ...
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.dataHorizontalLayout)
        self.modsLabel = QtWidgets.QLabel(EditConfigDialog)
        self.modsLabel.setObjectName("modsLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.modsLabel)
        ...
        self.formLayout.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.modsHorizontalLayout)
        self.pluginsLabel = QtWidgets.QLabel(EditConfigDialog)
        self.pluginsLabel.setObjectName("pluginsLabel")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.pluginsLabel)
        ...
        self.formLayout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.pluginsHorizontalLayout)
        self.prefixLabel = QtWidgets.QLabel(EditConfigDialog)
        self.prefixLabel.setObjectName("prefixLabel")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.prefixLabel)
        self.prefixLineEdit = QtWidgets.QLineEdit(EditConfigDialog)
        self.prefixLineEdit.setObjectName("prefixLineEdit")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.prefixLineEdit)
