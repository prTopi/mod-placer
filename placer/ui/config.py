...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        self.formLayout_2 = QtWidgets.QFormLayout(ConfigDialog)
        self.formLayout_2.setObjectName("formLayout_2")
        self.apiLabel = QtWidgets.QLabel(ConfigDialog)
        self.apiLabel.setObjectName("apiLabel")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.apiLabel)
        self.apiLineEdit = QtWidgets.QLineEdit(ConfigDialog)
        self.apiLineEdit.setObjectName("apiLineEdit")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.apiLineEdit)
        self.configLabel = QtWidgets.QLabel(ConfigDialog)
        self.configLabel.setObjectName("configLabel")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.configLabel)
        ...
        self.formLayout_2.setLayout(2, QtWidgets.QFormLayout.FieldRole, self.buttonsHorizontalLayout)
        self.focusLabel = QtWidgets.QLabel(ConfigDialog)
        self.focusLabel.setObjectName("focusLabel")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.focusLabel)
        self.focusCheckBox = QtWidgets.QCheckBox(ConfigDialog)
        self.focusCheckBox.setObjectName("focusCheckBox")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.focusCheckBox)
        self.exitLabel = QtWidgets.QLabel(ConfigDialog)
        self.exitLabel.setObjectName("exitLabel")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.exitLabel)
        self.exitCheckBox = QtWidgets.QCheckBox(ConfigDialog)
        self.exitCheckBox.setObjectName("exitCheckBox")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.exitCheckBox)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.prettyCheckBox)
        self.prettyLabel = QtWidgets.QLabel(ConfigDialog)
        self.prettyLabel.setObjectName("prettyLabel")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.prettyLabel)
