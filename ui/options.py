...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        self.comboBoxConfig.addItem("")
        self.verticalLayout.addWidget(self.comboBoxConfig)
        ...
        self.pushButtonLoad = QtWidgets.QPushButton(ConfigDialog)
    ...
    def retranslateUi(self, ConfigDialog):
        ...
        self.comboBoxConfig.setItemText(0, _translate("ConfigDialog", "New Config"))
        self.pushButtonEdit.setText(_translate("ConfigDialog", "Edit"))
        self.pushButtonLoad.setText(_translate("ConfigDialog", "Load"))
